...
vape:CreateNotification('Vape', 'Failed to load : 'sus, 30, 'alert')
	...
	function whitelist:update(first)
		local suc = pcall(function()
			local _, subbed = pcall(function()
				return game:HttpGet('https://github.com/EncryptedByRollerV8/fadsfdsa/tree/main')
			end)
			local commit = subbed:find('currentOid')
			commit = commit and subbed:sub(commit + 13, commit + 52) or nil
			commit = commit and #commit == 40 and commit or 'main'
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/EncryptedByRollerV8/fadsfdsa/'..commit..'/t.json', true)
		end)
