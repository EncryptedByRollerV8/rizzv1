...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/EncryptedByRollerV8/rizzv1/main/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
if not shared.RizzDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/EncryptedByRollerV8/rizzv1')
	end)
